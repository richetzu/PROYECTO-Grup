...
import { agregarCarrito } from '../services/carritoDB';
...
export default function TarjetaProductos(props) {
  ...
  const handleAgregar = async () => {
    ...
    const resultado = await agregarCarrito(producto);
    ...
    if (resultado.success) {
      ...
      ToastAndroid.show('Error al agregar al carrito', ToastAndroid.SHORT);
